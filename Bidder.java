            ...
            while (items.size() > 0)
            {
                ...
                if (price < this.cash - sumActiveBids)
                {
                    ...
                    if (success)
                    {
                       ...
                       //System.out.println("Bid is successfull for: "+ this.name()); 
                    }
                    break;
                }
            ...
            for (Item bid : activeBids)
            {
                switch (server.checkBidStatus(this.name(), bid.listingID()))
                {
                    case 1:
                       ...
                       // System.out.println("Congrats on winning the bid "+this.name());
                    ...
                    case 2:
                        ...
                        //System.out.println("Wait bidding is still on");
                        break;

                    case 3:
                        // Failed
                        sumActiveBids -= activeBidPrices.get(bid);
                        System.out.println("Bidding failed Sorry");
                        break;

                    default:
                        // Error
                    	System.out.println("Item was not present in items And Ids");
                        break;
                }
            }
